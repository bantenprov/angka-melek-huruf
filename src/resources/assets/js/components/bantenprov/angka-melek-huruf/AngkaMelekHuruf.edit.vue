<template>
  <div class="card">
    <div class="card-header">
      <i class="fa fa-table" aria-hidden="true"></i> Edit Angka Melek Huruf
...
export default {
  mounted() {
    axios.get('api/angka-melek-huruf/' + this.$route.params.id + '/edit')
      .then(response => {
      ...
      .catch(function(response) {
        alert('Break');
        window.location.href = '#/admin/angka-melek-huruf';
      });
  },
  data() {
    return {
  ...
  methods: {
    onSubmit: function() {
      ...
      if (this.state.$invalid) {
        ...
        axios.put('api/angka-melek-huruf/' + this.$route.params.id, {
    ...
    back() {
      window.location = '#/admin/angka-melek-huruf';
    }
  }
}
</script>
