<template>
  <div class="card">
    <div class="card-header">
      <i class="fa fa-table" aria-hidden="true"></i> Angka Melek Huruf
...
export default {
  ...
  methods: {
    createRow() {
      window.location = '#/admin/angka-melek-huruf/create';
    },
    viewRow(rowData) {
      window.location = '#/admin/angka-melek-huruf/' + rowData.id;
    },
    editRow(rowData) {
      window.location = '#/admin/angka-melek-huruf/' + rowData.id + '/edit';
    },
    deleteRow(rowData) {
      let app = this;

      if (confirm('Do you really want to delete it?')) {
        axios.delete('/api/angka-melek-huruf/' + rowData.id)
